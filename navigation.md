...
[📖  MDwiki]()
  ...
  * #MDwiki Gimmicks 測試
  ...
  - [仿 Github 的中國版平台 Coding.net](https://landerso.coding.me/)
  - #無資料夾結構的版本暫時不更新
...
[網站字體]()  
  ...
  - [抽取要用的文字：サブセットフォントメーカー](http://opentype.jp/subsetfontmk.htm)
...
[🔃  2016.12.16 更新]()
  ...
  - #更新項目
  - [🆕 通報使用者過多錯誤嘗試 + 時間鎖 完成](#!update.md#[2016.12.17]_通報使用者過多錯誤嘗試_+_時間鎖_完成 "2016.12.17")
  ...
  - [🆕 JANDI 彈性輸入 完成](#!update.md# "2016.12.04")
  - [🆕 JANDI basic 完成](#!update.md# "2016.12.03")
  - [🆕 硬碟報告更新到 Q3](#!update.md# "2016.11.30")
  - [🆕 修正錯誤深層連結，強推新人源柔字體XD](#!update.md# "2016.11.28")
  - [🆕 新增設置 LINE 給站長教學影片與文章](#!update.md# "2016.11.27")
  - [🆕 優化 LINE 服務台、秘密基地 介面](#!update.md# "2016.11.26")
  - [🆕 增加 LINE 服務台、秘密基地](#!update.md# "2016.11.25")
  - [🆕 增加 LINE 通報、本站 LINE、站長機器人 LINE](#!update.md# "2016.11.24")
  - [🆕 增加 JANDI 錯誤紀錄功能](#!update.md# "2016.11.17")
  - [🆕 測試性增加交流/給我意見](#!update.md# "2016.11.16")
  - [🆕 增加 部分配色背景漸變](#!update.md# "2016.11.15")
  - [🆕 實驗性增加 coding.me、Github 調整為主要、拿掉忍者觀察](#!update.md# "2016.11.14")
  - [🆕 修改燈箱獨立 function、優化燈箱開啟驗證](#!update.md# "2016.11.12 本來只驗證建立，現在也驗證開啟。")
  - [🆕 建立燈箱獨立 function](#!update.md# "2016.11.11")
  - [🆕 新增 其他輕量版固定字體，並在介面做收納。](#!update.md# "2016.11.10")
  - [🆕 新增 手動輕量版的「Kazesawa フォント」、「源暎ラテゴ」](#!update.md# "2016.11.09")
  - [🆕 新增 共鳴](# "2016.11.08")
  - [🆕 新增 站外工具/原價屋硬碟真比價書籤工具](#!update.md# "2016.11.01")
  - [🆕 新增 線上網頁字體：有華康(動態變化)、Google 思源](#!update.md# "2016.10.30")
  - [🆕 增加 字體變化測試 function](#!update.md# "2016.10.22 完成待補寫，Icon font 暫時不考慮")
  - [🆕 增加 手機板 Chrome 變色處理、繁簡轉換修正、完成 Line](#!update.md# "2016.10.21 完成待補寫")
